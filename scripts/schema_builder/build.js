/* This is a copy paste from @ideditor/schema-builder, only changing path of files, to allow new attributes in schema*/
...
const fetchTranslations = schemaBuilder.fetchTranslations;
